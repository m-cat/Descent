...
void init_parse_config() {
	...
	TCOD_parser_struct_t	actor_struct = TCOD_parser_new_struct(actor_parser, "actor_type");
	...
	TCOD_parser_struct_t	block_struct = TCOD_parser_new_struct(block_parser, "block_type");
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
