    ...
    case MENU_NAME:
        ...
        do {
            ...
            cprint(OFFSET_NAME_Y, OFFSET_NAME_X, TCOD_white, TCOD_black,
                   "> %s_", str);
            cprint(OFFSET_NAME_Y, OFFSET_NAME_X + max_len + 1, TCOD_white,
                   TCOD_black, " "); /* erase '_' if at end */
            cprint(1, 1, TCOD_white, TCOD_black,
                   "Welcome, adventurer! What is your name?");
            cprint(5, 1, TCOD_white, TCOD_black,
                   "Press space for a random name.");
            TCOD_console_flush();
...
main_menu:
    ...
    do {
        ...
        case TCODK_UP:
            MENU_CHOICE =
                (MENU_CHOICE == 0) ? MENU_NUM_CHOICES - 1 : MENU_CHOICE - 1;
            break;

        case TCODK_DOWN:
            MENU_CHOICE =
                (MENU_CHOICE == MENU_NUM_CHOICES - 1) ? 0 : MENU_CHOICE + 1;
            break;
