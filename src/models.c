...
const MODEL_ACTOR   DEFAULT_ACTOR = {
    .type = ACTOR_ENEMY,
    .name = "",
    .art = "",
    .ch = '?',
    ...
    .CAN_MOVE = 1, .CAN_WALK = 1, .CAN_SWIM = 1,
    .CAN_FLY = 0, .CAN_BURROW = 0
};

const MODEL_BLOCK   DEFAULT_BLOCK = {
    .type = TILE_NOTHING,
    .name = "",
    .art = "",
    .ch = '?',
...
void init_item_models() {
    ...
    model_diamond.art = "a";
    model_diamond.ch = ',';
    model_diamond.col = (TCOD_color_t) {
        0, 191, 255
    };
...
void init_block_models() {
    ...
    model_wall.art = "a";
    model_wall.ch = '#';
    model_wall.col_vis = (TCOD_color_t) {
        158, 134, 100
    };
    model_wall.col_nonvis = (TCOD_color_t) {
        63, 50, 31
    };
    ...
    model_floor.art = "the";
    model_floor.ch = '.';
    model_floor.col_vis = (TCOD_color_t) {
        158, 134, 100
    };
    model_floor.col_nonvis = (TCOD_color_t) {
        63, 50, 31
    };
